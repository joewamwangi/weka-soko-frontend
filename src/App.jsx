    ...
    {!loading&&tab==="settings"&&<>
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        ...
        <button className="btn br2" style={{justifyContent:"flex-start",gap:10}} onClick={async()=>{
          ...
          if(!pw)return;
          if(!window.confirm("Permanently delete your account? All listings and data will be removed. This CANNOT be undone."))return;
          try{
            await api("/api/auth/account",{method:"DELETE",body:JSON.stringify({password:pw})},token);
